...
class ApplicantMenu extends Component
{
    ...
    {
        return view('livewire.applicant-menu', ['applicants' => Applicants::where('name', 'like', '%'.$this->search.'%')->paginate(5)]);
    }
    ...
    // Fungsi untuk mengedit applicant
    ...
    // Simpan perubahan applicant
    public function saveUpdate($id)
    {
        $applicant = Applicants::findOrFail($id);

        $this->validate([
            // Validasi yang sama seperti saat create
        ]);
